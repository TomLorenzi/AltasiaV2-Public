class SettingsMenu {
    ...
    class controlsBackground {
        ...
        class GrassHeader : PlayerTagsHeader {
            idc = -1;
            text = "Herbe On/Off";
            y = 0.63;
        };

        class FilterHeader : PlayerTagsHeader {
            idc = -1;
            text = "Filtre couleur";
            y = 0.68;
        };
    ...
    class controls {
        ...
        class GrassONOFF : PlayerTagsONOFF {
            idc = 2973;
            tooltip = "Active ou cache l'herbe";
            onCheckedChanged = "['grass',_this select 1] call life_fnc_s_onCheckedChange;";
            y = 0.63;
        };

        class FilterONOFF : PlayerTagsONOFF {
            idc = 2973;
            tooltip = "Active ou cache l'herbe";
            onCheckedChanged = "['filter',_this select 1] call life_fnc_s_onCheckedChange;";
            y = 0.68;
        };

...
_query = format ["SELECT id, side, classname, type, pid, alive, active, plate, color, insure FROM vehicles WHERE pid='%1' AND alive='1'  AND fourriere='0' AND active='0' AND side='%2' AND type='%3'",_pid,_side,_type];
